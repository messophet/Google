#borrowed code from http://pythonsweetness.tumblr.com/post/45227295342/fast-pypy-compatible-ordered-map-in-89-lines-of
...
onetotwentysix = [x for x in range(1,27)]
zipped = zip(az,onetotwentysix)
[skip.insert(x,y) for x,y in zipped]
a = list(skip.items())
